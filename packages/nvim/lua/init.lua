...
require(
	...
	install = {
		colorscheme = {
			"tokyonight",
		}, -- Assuming tokyonight is your theme
...
require(
	"utils.reload"
).setup() -- Setup the config reload command
...
-- to ensure it runs after nvim-lspconfig and other LSP plugins are loaded by lazy.nvim.
...
print(
	"Neovim configuration loaded from lua/init.lua"
)
