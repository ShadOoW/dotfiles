...
require('plugins.ui'), require('plugins.lsp'), require('plugins.cmp'), require('plugins.ai'), require('plugins.tools'),
require('plugins.git'), require('plugins.editor'), require('plugins.debug')}
