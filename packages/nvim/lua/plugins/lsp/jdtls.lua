return {
	...
	config = function()
		...
		local root_markers =
			{
				...
				".classpath",
				".project",
				"src/main/java", -- Standard Maven/Gradle layout
		...
		local function get_jdtls_paths()
			...
			local path_to_config = path
				.. "/config_linux"
			local path_to_plugins = path
				.. "/plugins"
			local path_to_jar =
				vim.fn.glob(
					path_to_plugins
		...
		local function jdtls_setup(
			...
			then
				root_dir =
					vim.fn.getcwd()
				print(
					"JDTLS: No project root found, using current directory: "
						.. root_dir
				)
			else
				print(
					"JDTLS: Using project root: "
						.. root_dir
				)
			end
