return {
    ...
    keys = function()
        ...
        local trouble_panels = {
            diagnostics = {
                open = function(opts)
                    require('trouble').open('diagnostics', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('diagnostics', opts)
                end,
                close = function()
            ...
            loclist = {
                open = function(opts)
                    require('trouble').open('loclist', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('loclist', opts)
                end,
                close = function()
                    require('trouble').close()
                end,
            ...
            qflist = {
                open = function(opts)
                    require('trouble').open('qflist', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('qflist', opts)
                end,
                close = function()
                    require('trouble').close()
                end,
            ...
            lsp_references = {
                open = function(opts)
                    require('trouble').open('lsp_references', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('lsp_references', opts)
                end,
                close = function()
                    require('trouble').close()
                end,
            ...
            symbols = {
                open = function(opts)
                    require('trouble').open('symbols', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('symbols', opts)
                end,
                close = function()
                    require('trouble').close()
                end,
            ...
            lsp_document_symbols = {
                open = function(opts)
                    require('trouble').open('lsp_document_symbols', opts)
                end,
                toggle = function(opts)
                    require('trouble').toggle('lsp_document_symbols', opts)
                end,
                close = function()
                    require('trouble').close()
                end,
