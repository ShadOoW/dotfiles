...
return {
    ...
    config = function()
        ...
        local function get_project_name()
            ...
            -- Python projects
            if vim.fn.filereadable(cwd .. '/pyproject.toml') == 1 or vim.fn.filereadable(cwd .. '/setup.py') == 1 or
                vim.fn.filereadable(cwd .. '/requirements.txt') == 1 then
                return ' ' .. project_name
            end
        ...
        local function notification_error_count()
            ...
            if not _G.notification_utils then
                return ''
            end
                    ...
                    fmt = function(str)
                        ...
                        if filetype == 'trouble' then
                            ...
                            if _G.current_trouble_mode then
                                ...
                                return mode_map[_G.current_trouble_mode] or
                                           (' ' .. (_G.current_trouble_mode:gsub('_', ' '):gsub('^%l', string.upper)))
                            end
                        ...
                        if buf_name:match('^trouble://') or buf_name:find('trouble') then
                            ...
                            if trouble_type then
                                ...
                                return type_map[trouble_type] or
                                           (' ' .. trouble_type:gsub('_', ' '):gsub('^%l', string.upper))
                            end
                            return ' Trouble'
                        end
