...
return {
  ...
  config = function()
    ...
    oil.setup({
      ...
      -- options with a `callback` (e.g. { callback = function() ... end, desc = "my keymap" } )
      -- Additionally, if it is a string that matches "actions.<action_name>",
      -- it will use the mapping at require("oil.actions").<action_name>
