...
local servers = {"html", "cssls", "ts_ls", "eslint", "tailwindcss", "astro", "emmet_ls", "jsonls", "yamlls", "marksman",
                 "bashls", "dockerls", "denols", "clangd", "lua_ls"}
...
for _, server_name in ipairs(servers) do
    ...
    if ok then
        ...
        if type(config) ~= "table" then
            print("✗ " .. server_name .. " - configuration is not a table")
        end
    else
